...
const buildDefaultChatSystemPrompt = async () => {
  ...
  return [
    ...
    'Используй только форматы, цены, контакты и этапы из контекста сайта. Не придумывай бесплатную или пробную диагностику, созвоны, скидки, гарантии, даты, способы оплаты и дополнительные услуги. Не обещай быстрый эффект, облегчение или результат. “Диагностика запроса” — этап процесса, а не отдельная бесплатная услуга.',
