(() => {
  ...
  const renderLegal = async () => {
    ...
    const incomplete = !data.settings.sellerLegalName || !data.settings.sellerStatus || !data.settings.inn || !data.settings.legalAddress || !data.settings.phone || !data.settings.email || (!isSelfEmployed && !data.settings.ogrn);
